	...
	<div class="container">
		...
		<?php if($error): ?>
			<div class="alert alert-error">
				Something has gone wrong. Error(s) have been sent back from the API. Please check to make sure all of your inputs below are valid.
			</div>
		<?php endif; ?>
		...
		<input type="hidden" name="action" value="validate" />
			...
			<?php elseif($f['type'] == 'date_of_birth'): ?>
				<div class="form-group row">
					<label for="<?=$f['name']?>" class="col-sm-3 col-form-label"><?=$f['label']?></label>
					<div class="col-sm-3">
						<select name="<?=$f['name']?>_month" class="form-control" id="<?=$f['name']?>_month">
						<option value="--">--</option>
					...
					<div class="col-sm-2">
						<select name="<?=$f['name']?>_day" class="form-control" id="<?=$f['name']?>_day">
						<option value="--">--</option>
						<?php for($i=1; $i<=31; $i++): ?>
							<option value="<?php if($i<=10): ?>0<?=$i?><?php else: ?><?=$i?><?php endif; ?>"><?=$i?></option>
						<?php endfor; ?>
						</select>
					</div>
					<div class="col-sm-2">
						<select name="<?=$f['name']?>_year" class="form-control" id="<?=$f['name']?>_year">
						<option value="--">--</option>
						<?php for($i=1917; $i<=2017; $i++): ?>
							<option value="<?=$i?>"><?=$i?></option>
						<?php endfor; ?>
						</select>
					</div>
				</div>
			<?php elseif($f['type'] == 'gender'): ?>
				<div class="form-group row">
					<label for="<?=$f['name']?>" class="col-sm-3 col-form-label"><?=$f['label']?></label>
					<div class="col-sm-9">
						<div class="form-check form-check-inline">
							<label class="form-check-label">
							<input class="form-check-input" type="radio" name="gender" id="gender_male" value="male"> Male
							</label>
						</div>
						<div class="form-check form-check-inline">
							<label class="form-check-label">
							<input class="form-check-input" type="radio" name="gender" id="gender_female" value="female"> Female
							</label>
						</div>
					</div>
				</div>
			<?php elseif($f['type'] == 'phone'): ?>
				<div class="form-group row">
					<label for="<?=$f['name']?>" class="col-sm-3 col-form-label"><?=$f['label']?></label>
					<div class="col-sm-3">
						<select name="<?=$f['name']?>_country" class="form-control" id="<?=$f['name']?>_country">
					...
					<div class="col-sm-5">
						<input type="input" name="<?=$f['name']?>_value" class="form-control" id="<?=$f['name']?>_value">
					</div>
				</div>
			...
			<?php elseif($f['type'] == 'country'): ?>
				<div class="form-group row">
					<label for="<?=$f['name']?>" class="col-sm-3 col-form-label"><?=$f['label']?></label>
					<div class="col-sm-8">
						<select name="<?=$f['name']?>" class="form-control" id="<?=$f['name']?>">
							<option value="AF">Afghanistan</option>
							<option value="AX">Åland Islands</option>
							<option value="AL">Albania</option>
							<option value="DZ">Algeria</option>
